...
#app {
  min-height: 100vh;
  background: #121218; /* Основной тёмный фон */
  color: #e0e0e0;
  display: flex;
...
.app-content {
  flex: 1;
  padding: 2rem;
  background: linear-gradient(to bottom, rgba(18, 18, 24, 0.9), rgba(15, 15, 20, 0.95));
}
...
/* Стили для навигации (уже есть в вашем коде) */
.main-nav {
  position: relative;
  display: flex;
  gap: 1.5rem;
